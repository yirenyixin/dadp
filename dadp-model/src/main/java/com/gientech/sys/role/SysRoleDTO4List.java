...
/**
 * 【角色】SysRole查询DTO类【不要的属性，一定要删除！发现3次要开除】
 */
@Data
@ApiModel(value = "角色--查询条件的DTO类")
@JsonIgnoreProperties(value = { "orderBy" }) // 字段不接受前台传参，防止sql注入
public class SysRoleDTO4List implements Serializable {
	...
	@ApiModelProperty(value = "登录后首页", position = 15)
