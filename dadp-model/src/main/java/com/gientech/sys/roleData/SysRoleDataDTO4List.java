...
/**
 * 【数据权限】SysRoleData查询DTO类【不要的属性，一定要删除！发现3次要开除】
 */
@Data
@ApiModel(value = "数据权限--查询条件的DTO类")
public class SysRoleDataDTO4List implements Serializable {
	...
	@ApiModelProperty(value = "角色ID", required = true, position = 14)
