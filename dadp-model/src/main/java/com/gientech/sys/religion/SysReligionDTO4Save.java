...
/**
 * 【宗教】SysOrg新增DTO类【不要的属性，一定要删除！发现3次要开除】
 */
@Data
@ApiModel(value = "宗教--新增DTO")
public class SysReligionDTO4Save implements Serializable {
    ...
    @NotBlank(message = "[religionName]机构名称，不能为空")
